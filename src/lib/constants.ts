      ...
      skills:
        lang === 'id'
          ? [
              ...
              'Manajemen Risiko',
              'LAN/WAN',
              'Pengujian & Troubleshooting Sistem',
            ]
          : [
              'Network Security',
              'Threat Analysis',
...
export const getFeaturedProject = (lang: 'en' | 'id') => {
  return {
    ...
    title:
      lang === 'id'
        ? 'Sistem Informasi Pengelolaan Keuangan Masjid Berbasis Web (Skripsi)'
        : 'Web-Based Mosque Financial Management System (Thesis)',
    description:
      lang === 'id'
    ...
    tags:
      lang === 'id'
        ? ['Pengembangan Web', 'Cash Basis', 'Desain Sistem']
        : ['Web Development', 'Cash Basis Accounting', 'System Design'],
    features:
      lang === 'id'
        ? [
...
export const getOtherProjects = (lang: 'en' | 'id') => {
  return [
    ...
    },
    {
      ...
      title:
        lang === 'id'
          ? 'Aplikasi Kalkulasi Anggaran Berbasis Web (Magang)'
          : 'Web-Based Budget Calculation Application (Internship)',
      description:
        lang === 'id'
      ...
      tags:
        lang === 'id'
          ? ['Analisis Sistem', 'Aplikasi Web', 'Manajemen Data']
          : ['System Analysis', 'Web Application', 'Data Management'],
  ...
  return [
    {
      ...
      type: 'certification',
      title:
        lang === 'id' ? 'Google Cybersecurity Certificate' : 'Google Cybersecurity Certificate',
    ...
    },
    {
      ...
      type: 'experience',
      title:
        lang === 'id' ? 'Staf IT / Administrasi (Magang)' : 'IT / Administrative Staff (Intern)',
    ...
    },
    {
      ...
      title:
        lang === 'id'
          ...
          : 'National Professional Certification (BNSP) — Machining',
    ...
    },
    {
      ...
      details:
        lang === 'id'
          ? 'Lulus dengan nilai kelulusan 81.79 / 100.'
          : 'Graduated with a final score of 81.79 / 100.',
    },
    {
      id: 7,
      type: 'experience',
