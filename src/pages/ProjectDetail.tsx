  ...
  return (
    <div className="min-h-[100svh] bg-[#fafafa] dark:bg-[#030712] text-zinc-800 dark:text-zinc-200 pt-24 pb-12 transition-colors duration-300">
      <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-zinc-500 dark:text-zinc-400 hover:text-electric-blue dark:hover:text-electric-blue transition-colors mb-8 group"
        >
        ...
        <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
          <motion.div variants={fadeInUp} className="mb-8">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 mb-8">
              {project.tags.map((tag) => (
                <span
                  key={tag}
                  className="px-3 sm:px-4 py-1.5 sm:py-2 bg-zinc-100 dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-full text-xs sm:text-sm text-cyan-600 dark:text-cyan-accent shadow-sm dark:shadow-none"
                >
                  {tag}
                </span>
              ))}
          ...
          <motion.div
            variants={fadeInUp}
            className="rounded-2xl overflow-hidden mb-10 sm:mb-12 border border-zinc-200 dark:border-white/10 shadow-md"
          >
            <img
              src={project.image}
              alt={project.title}
              ...
              <div className="minimal-card p-5 sm:p-6 rounded-2xl shadow-sm border border-zinc-200 dark:border-white/10">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <ExternalLink
                      size={16}
                      className="text-zinc-400 group-hover:text-electric-blue dark:group-hover:text-white transition-colors"
                    />
                  </a>
                  <a
                    href="#"
